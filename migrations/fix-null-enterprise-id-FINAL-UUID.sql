...
-- FINAL VERSION: Uses UUID for both enterprises and enterprise_settings
...
BEGIN
  ...
  -- Both enterprises.id and enterprise_settings.enterprise_id are UUID
  ...
  VALUES (
    v_enterprise_id,  -- Use UUID directly, not converted to string
    true,
    false,
    true,
    true,
